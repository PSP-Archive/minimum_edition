...
#elif ( PSP_MODEL == 1 || PSP_MODEL == 2 || PSP_MODEL == 3 || PSP_MODEL == 6 || PSP_MODEL == 8 )
	//02g 03g
...
#define MemlmdDecryptAddr	0x134
...
#if PSP_MODEL == 0
//#define MemlmdTagPatchAddr	0x000013F0//0x00001308
	//memlmd_F26A33C3
...
#elif ( PSP_MODEL == 2 ||  PSP_MODEL == 3 ||  PSP_MODEL == 6 ||  PSP_MODEL == 8)//03g
