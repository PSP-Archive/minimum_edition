...
char **TextAddrList[] = {
	...
	&(menu_ad_cnf[2].path),//XMB  plugins
	&(menu_ad_cnf[3].path),//GAME plugins
	&(menu_ad_cnf[4].path),//POPS plugins
...
//	&(menu_config[2].path),//Game folder homebrew
	...
	&(menu_config[14].path),//Speed up MS access
